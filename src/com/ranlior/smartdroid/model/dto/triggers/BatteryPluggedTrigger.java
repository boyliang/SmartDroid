...
public class BatteryPluggedTrigger extends Trigger {
	 ...
	 * The trigger's name. 
	 */
	private static final String NAME = "Battery plugged state changed";
	
	/**
	 * The trigger's description.
	 */
	private static final String DESCRIPTION = "Trigged when the battery plugged state changes (not pluged / ac plugged / usb plugged / wireless plugged)";
